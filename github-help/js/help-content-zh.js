    ...
    connectors: {
        ...
        articles: [
            ...
            },
            {
                ...
                <p>如果您不希望通过 WhatsApp 切换模型，请在连接器选项卡中点击 <strong>锁定 AI 模型</strong>。</p>
            ...
            },
            {
                ...
                <div class="note"><p><strong>注意：</strong>当您把演示文稿 HTML 文件下载到电脑后，可以使用右上角的小工具栏离线编辑它。手机和平板不支持这一编辑流程。使用 <strong>Edit text</strong> 可以直接修改文字，点击演示文稿中的任意图片即可将其替换为本地图像，使用 <strong>Fullscreen</strong> 可以全屏查看演示文稿，使用 <strong>Save</strong> 可以把更新后的结果另存为新的 HTML 文件。演示文稿进入全屏模式时，工具栏会自动隐藏。</p></div>
                <ul>
