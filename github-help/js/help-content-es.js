    ...
    connectors: {
        ...
        articles: [
            ...
            },
            {
                ...
                <div class="note"><p><strong>Nota:</strong> Cuando descargues el archivo HTML de la presentación en tu ordenador, podrás editarlo sin conexión con la pequeña barra de herramientas de la esquina superior derecha. Este flujo de edición no es compatible con teléfonos ni tablets. Haz clic en <strong>Edit text</strong> para modificar cualquier texto directamente, haz clic en <strong>Replace image</strong> para sustituir la imagen de la diapositiva actual por una imagen local y luego guarda el resultado como un nuevo archivo HTML. La barra de herramientas desaparece automáticamente cuando la presentación está en pantalla completa.</p></div>
                <ul>
