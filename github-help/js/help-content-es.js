window.helpContent = {
    ...
    gettingstarted: {
        ...
        intro:
            [
                ...
                "Instrucciones detalladas para usar modelos cloud de Ollama: 1) Descarga Paiperwork desde https://infinitai-cn.github.io/paiperwork/. 2) Descomprime el archivo. 2.1) Si no puedes abrir Paiperwork, revisa la configuracion de seguridad para permitir su ejecucion. En Windows, haz clic en el boton More info. En macOS, abre Privacidad y seguridad en Configuracion. 3) Ve a https://ollama.com y crea tu cuenta. 4) Descarga e instala Ollama. 5) En tu cuenta de Ollama abre Settings. 6) Abre Usage para ver cuanto uso gratis te queda (importante). 7) Abre Keys, haz clic en Add API key, luego en Generate API key, y copia la clave generada. 8) Guarda la clave en un archivo de texto en tu ordenador. 9) Ejecuta Paiperwork (Mac, Windows o Linux). 10) Introduce una clave maestra y, en la pestana Chat, haz clic en Manage Cloud API key y agrega tu clave API de Ollama. 11) Ya puedes usar los modelos cloud gratis de Ollama.",
                "Aviso de modo online (<a href=\"https://huggingface.co/spaces/Infinitai/Paiperwork\" target=\"_blank\" rel=\"noopener noreferrer\">Hugginface spaces</a>): Debido a requisitos locales, las pestanas Documents, Translate, Models y Connectors estan deshabilitadas en modo online. Estas pestanas se habilitan al ejecutar Paiperwork en tu ordenador."
            ],
        articles: [
            {
                id: "gs-welcome",
    ...
    documents: {
        ...
        articles: [
            ...
            },
            {
                ...
                <div class="note">
                    <p><strong>Nota sobre modelos en la nube:</strong> Al usar modelos en la nube en planes gratuitos, las respuestas en el modo "Hacer preguntas" pueden limitarse o truncarse porque los prompts de RAG son grandes. Si necesitas respuestas largas y completas de forma consistente, usa un plan de pago.</p>
                </div>
            `,
    ...
    campaign: {
        title: "Campaign",
        intro:
            "Campaign Studio te ayuda a definir un briefing de campaña completo con sparring de IA y luego generar y refinar un póster, una presentación y una mini app desde una única fuente compartida.",
        articles: [
            {
                id: "campaign-overview",
                title: "Para qué sirve Campaign Studio",
                content: `
                <p>Campaign Studio está diseñado para usuarios que quieren pasar de una idea inicial a un paquete de campaña coordinado sin gestionar herramientas separadas para estrategia, texto y generación de artefactos.</p>

                <h4>Objetivo principal</h4>
                <p>La función combina lluvia de ideas estratégica con producción estructurada de campañas. En lugar de pedir por separado un póster, una presentación y una mini app, construyes un único briefing de campaña y el sistema lo reutiliza en las tres salidas.</p>

                <h4>Qué puede generar</h4>
                <ul>
                    <li><strong>Póster</strong> - Un póster visual generado a partir del briefing de campaña, la sección específica del briefing para el póster y la imagen de campaña subida</li>
                    <li><strong>Presentación</strong> - Una presentación HTML editable por prompt alineada con la misma dirección de campaña</li>
                    <li><strong>Mini App</strong> - Una mini app HTML editable por prompt guiada por el briefing de campaña y restricciones específicas de funcionalidad para la mini app</li>
                </ul>

                <h4>Capacidades clave</h4>
                <ul>
                    <li><strong>Fuente única de verdad</strong> - El briefing de campaña editable impulsa todas las salidas</li>
                    <li><strong>Sparring con IA</strong> - El orquestador ayuda a refinar posicionamiento, audiencia, tono y texto antes de generar</li>
                    <li><strong>Campañas guardadas</strong> - Guarda campañas en la base de datos local cifrada y vuelve a abrirlas más tarde</li>
                    <li><strong>Regeneración dirigida</strong> - Regenera solo la presentación, la mini app o el póster sin volver a ejecutar todo el flujo del estudio</li>
                    <li><strong>Edición segura por variantes</strong> - Las ediciones manuales de las salidas se conservan en memoria y pueden guardarse como nuevas variantes en lugar de sobrescribir silenciosamente una campaña maestra</li>
                </ul>

                <h4>Flujo de trabajo típico</h4>
                <ol>
                    <li>Abre la pestaña Campaign y haz clic en <strong>Open Studio</strong></li>
                    <li>Sube la imagen principal de la campaña</li>
                    <li>Usa el chat del orquestador para dar forma a la estrategia de la campaña</li>
                    <li>Revisa y edita el Campaign Brief</li>
                    <li>Haz clic en <strong>Generate Campaign</strong> para crear la presentación, la mini app y el póster</li>
                    <li>Abre cada vista y refina los resultados</li>
                    <li>Guarda la campaña cuando el briefing y las salidas estén en un estado que quieras conservar</li>
                </ol>
            ...
            },
            {
                ...
                title: "Cómo usar el orquestador",
                content: `
                <p>El orquestador de Campaign está pensado como un compañero estratégico de sparring, no como un generador de un solo clic. Su trabajo es mejorar el briefing antes de que generes salidas.</p>

                <h4>Mejor uso previsto</h4>
                <ul>
                    <li><strong>Refinar el posicionamiento</strong> - Pídele que haga más preciso el ángulo, la promesa o la propuesta de valor de la campaña</li>
                    <li><strong>Mejorar el ajuste con la audiencia</strong> - Pídele que cuestione si la campaña está hablando a las personas adecuadas</li>
                    <li><strong>Fortalecer el mensaje</strong> - Úsalo para mejorar títulos, subtítulos, puntos clave, la sección del briefing del póster o el tono</li>
                    <li><strong>Ajustar la mini app</strong> - Indícale qué tipos de funciones añadir, quitar, evitar o enfatizar en la mini app</li>
                    <li><strong>Poner a prueba las ideas</strong> - Pregunta qué se siente demasiado genérico, débil, cargado o poco claro antes de generar</li>
                </ul>

                <h4>Lo que el orquestador no hace</h4>
                <ul>
                    <li>No genera automáticamente las salidas de póster, presentación o mini app por sí solo</li>
                    <li>No decide cuándo empieza la ejecución</li>
                    <li>No reemplaza el briefing editable; ayuda a mejorarlo</li>
                </ul>

                <h4>Buenos ejemplos de prompts</h4>
                <ul>
                    <li><strong>Estrategia:</strong> "Esto se siente demasiado genérico. Haz la campaña más específica para cafeterías locales pequeñas."</li>
                    <li><strong>Tono:</strong> "Mantén la campaña persuasiva pero menos corporativa y más directa."</li>
                    <li><strong>Sección del briefing del póster:</strong> "Acorta el lenguaje del póster y haz que se sienta más urgente."</li>
                    <li><strong>Ajuste de la mini app:</strong> "Para la mini app, evita botones de cabecera y mantén el diseño compacto y con apariencia de app en lugar de una landing page."</li>
                </ul>

                <div class="note">
                    <p><strong>Consejo:</strong> Trata al orquestador como un compañero creativo. Úsalo para iterar sobre el briefing hasta que la dirección de la campaña sea sólida y luego genera. Cuanto mejor sea el briefing, más coherentes serán las tres salidas.</p>
                </div>
            `,
            },
            {
                id: "campaign-brief",
                title: "Trabajar con el Campaign Brief",
                content: `
                <p>El Campaign Brief es la superficie central de edición dentro de Campaign Studio. Es intencionalmente editable para que puedas combinar sugerencias del orquestador con tus propias decisiones manuales.</p>

                <h4>Áreas editables del briefing</h4>
                <ul>
                    <li><strong>Título y subtítulo</strong> - Título principal de la campaña y línea de apoyo</li>
                    <li><strong>Mensaje central</strong> - Idea principal que la campaña debe comunicar</li>
                    <li><strong>Audiencia</strong> - El grupo objetivo de la campaña</li>
                    <li><strong>Tono</strong> - La voz y la sensación que deben transmitir las salidas</li>
                    <li><strong>Puntos clave</strong> - Ideas de apoyo que la campaña debe enfatizar</li>
                    <li><strong>Paleta de color de la campaña</strong> - Dirección visual para el estilo de la presentación y la mini app</li>
                    <li><strong>Sección del póster</strong> - Sección dedicada para encabezado, subencabezado, cuerpo y pie del póster</li>
                    <li><strong>Sección de mini app</strong> - Campos dedicados para añadir o eliminar funcionalidad de la mini app</li>
                </ul>

                <h4>Campos de añadir / eliminar en la mini app</h4>
                <p>La sección de Mini App contiene dos campos específicos:</p>
                <ul>
                    <li><strong>Añadir a la mini app</strong> - Úsalo para funciones o patrones de interacción que quieras incluir o enfatizar</li>
                    <li><strong>Eliminar de la mini app</strong> - Úsalo para funciones, controles o elementos de diseño que quieras que la mini app evite</li>
                </ul>
                <p>Estos campos no están pensados para convertirse en texto visible dentro de la app. Se interpretan como guía funcional para la generación y regeneración de la mini app.</p>

                <h4>Buenas prácticas para el briefing</h4>
                <ul>
                    <li>Mantén el título y el subtítulo concisos</li>
                    <li>Usa los puntos clave para ideas de apoyo, no para párrafos largos</li>
                    <li>Usa la sección del póster solo para texto breve del póster, no para notas estratégicas completas</li>
                    <li>Usa la sección de mini app para restricciones de funciones, como qué incluir, evitar, simplificar o eliminar</li>
                    <li>Revisa el briefing después de cada intercambio con el orquestador para saber exactamente qué guiará la generación</li>
                </ul>

                <div class="note">
                    <p><strong>Importante:</strong> El briefing no es solo una vista previa. Es la fuente editable de la campaña utilizada por los flujos de regeneración, por lo que los cambios manuales afectan directamente a futuras salidas de presentación, mini app y póster.</p>
                </div>
            `,
            },
            {
                id: "campaign-output-editing",
                title: "Edición de salidas de póster, presentación y mini app",
                content: `
                <p>Después de la generación, cada salida de Campaign tiene su propio flujo de edición. Esto te permite refinar los artefactos generados sin reiniciar toda la campaña.</p>

                <h4>Edición del póster</h4>
                <ul>
                    <li>El póster se abre dentro de la vista de Campaign con una superposición editable basada en canvas</li>
                ...
                <ul>
                    <li>La presentación se carga en un espacio de trabajo editable basado en iframe</li>
                    <li>Puedes editar texto directamente dentro de la presentación renderizada</li>
                    <li>Puedes hacer clic en imágenes y reemplazarlas usando las herramientas existentes de edición de presentaciones por prompt</li>
                    <li><strong>Regenerate</strong> vuelve a ejecutar solo el flujo de presentación a partir del briefing de campaña más reciente y el contexto actual de la campaña</li>
                    <li><strong>Save to disk</strong> exporta la presentación HTML actual incluyendo tus ediciones</li>
                </ul>

                <h4>Edición de la mini app</h4>
                <ul>
                    <li>La mini app usa el mismo modelo de edición por iframe editable que la presentación</li>
                    <li>Puedes editar texto directamente en el resultado renderizado</li>
                    <li>Puedes reemplazar imágenes manteniendo la dirección actual de la app</li>
                    <li><strong>Regenerate</strong> vuelve a ejecutar solo el flujo de la mini app reutilizando el briefing más reciente y los campos de personalización de la mini app</li>
                    <li><strong>Save to disk</strong> exporta la mini app HTML actual incluyendo tus ediciones</li>
                </ul>

                <h4>Comportamiento de regeneración y cancelación</h4>
                <ul>
                    <li>La Presentación y la Mini App tienen acciones de <strong>Regenerate</strong> dirigidas que cambian a <strong>Cancel</strong> mientras están en ejecución</li>
                    <li>Aparece una barra de progreso indeterminada en línea junto al botón de regeneración activo</li>
                    <li>Cancel detiene la regeneración dirigida sin iniciar el modal bloqueante del flujo completo de Campaign</li>
                </ul>

                <div class="note">
                    <p><strong>Consejo:</strong> Usa primero el briefing para mejorar la dirección estratégica y luego la edición por salida para ajustes locales como diseño, reemplazo de imágenes o limpieza final del texto. Así la regeneración se mantiene enfocada y reduce trabajo innecesario.</p>
                </div>
            `,
            },
        ],
    ...
    presentation: {
        ...
        `,
            ...
            <ul>
                ...
                <li><strong>Alternador de búsqueda web</strong> — después de <strong>Enviar</strong>, usa el alternador <strong>Web</strong> para construir contenido de la presentación desde resultados web usando el contenido de Add text como prompt de búsqueda; cuando está activo, el botón cambia a <strong>Prompt de búsqueda web</strong>.</li>
                <li><strong>Consejo para el prompt web</strong> — en este modo, escribe solo el tema de la presentación. Evita frases como «crear una presentación sobre...» porque pueden influir en la búsqueda web; introduce únicamente el tema.</li>
                <li><strong>Consejo para reemplazar imágenes</strong> — si una imagen no carga, o simplemente quieres cambiarla, haz clic en la imagen dentro de la vista previa e inicia una búsqueda de imágenes para reemplazarla.</li>
                <li><strong>Consejo para editar texto</strong> — los cuadros de texto se pueden editar directamente en la vista previa, para que puedas hacer ajustes finales antes de guardar la presentación HTML.</li>
                <li><strong>Modelo recomendado</strong> — para esta función, <strong>GLM 4.7 Flash</strong> es un muy buen modelo para presentaciones.</li>
    ...
    artifacts: {
        ...
        articles: [
            ...
            <ul>
                ...
                <li><strong>Compatibilidad de modelos</strong> - funciona con modelos locales o en la nube disponibles en el selector.</li>
            </ul>
        `,
            },
            {
    ...
    database: {
        ...
        articles: [
            ...
            {
                id: "database-backup",
                title: "Exportar e Importar Copias de Seguridad Completas",
                content: `
                <p>La pestaña Base de Datos incluye dos botones para mover sus datos entre navegadores o dispositivos de forma segura:</p>
                <ul>
                ...
                <p>La copia exportada incluye todos los roles de base de datos de Paiperwork:</p>
                <ul>
                    <li><strong>Main</strong> - Conversaciones y ajustes principales</li>
                    <li><strong>RAG</strong> - Fragmentos de documentos y datos de recuperacion</li>
                    <li><strong>HTML</strong> - Contenido HTML guardado de presentaciones y artifacts</li>
                    <li><strong>Knowledge Base</strong> - Colecciones y entradas de conocimiento</li>
                </ul>

                <h4>Comportamiento Importante al Importar</h4>
                <ul>
                    <li>La importacion <strong>reemplaza</strong> sus bases de datos locales actuales</li>
                    <li>La importacion <strong>no fusiona</strong> datos con el contenido existente</li>
                    <li>Despues de importar, Paiperwork vuelve a la pantalla de bienvenida para que introduzca de nuevo su Clave Maestra</li>
                </ul>

                <h4>Flujo Recomendado</h4>
                <ol>
                    <li>En el navegador de origen, abra Base de Datos y pulse "Exportar Base de Datos"</li>
                    <li>Copie el archivo <code>Paiperwork-Backup.pwdb</code> al navegador o dispositivo de destino</li>
                    <li>En el navegador de destino, abra Base de Datos y pulse "Importar Base de Datos"</li>
                    <li>Confirme el reemplazo y vuelva a iniciar sesion con su Clave Maestra</li>
                </ol>

                <div class="note">
                    <p><strong>Nota:</strong> Las importaciones heredadas de un solo <code>.db</code> siguen siendo compatibles, pero solo restauran la base principal. Use <code>Paiperwork-Backup.pwdb</code> para una portabilidad completa.</p>
                </div>
            `,
            },
            {
            ...
            },
            {
                ...
                <p>Si ocurren problemas persistentes y el mantenimiento normal no ayuda:</p>
                    ...
                    <li>Exporta cualquier conversación o documento importante primero</li>
                                <h4>Borrar Contextos de WhatsApp/WeChat</h4>
                                <p>Si las respuestas de WhatsApp/WeChat empiezan a sentirse sobrecargadas tras un uso prolongado, puedes borrar solo las conversaciones de WhatsApp/WeChat almacenadas por teléfono en la base de datos sin eliminar el resto de tu base de datos; las conversaciones relacionadas con Paiperwork no se eliminarán.</p>
                                <ol>
                                    <li>Haz clic en "Borrar Contextos de WhatsApp/WeChat" en la pestaña Conectores</li>
                                    <li>Esto elimina la memoria de contexto de WhatsApp/WeChat almacenada por teléfono y restablece el contexto activo de WhatsApp/WeChat en tiempo de ejecución</li>
    ...
    connectors: {
        title: "Conectores",
        intro: [
            "Nota: la versión online de Paiperwork alojada en Huggingface no incluye la funcionalidad de WhatsApp o WeChat por motivos de seguridad y privacidad del usuario.",
            "Idiomas compatibles con el orquestador de WhatsApp/WeChat: inglés, español, portugués, alemán, chino, francés, japonés, coreano y ruso.",
            "Los conectores enlazan Paiperwork con WhatsApp/WeChat. Las solicitudes solo usan recursos ya disponibles dentro de Paiperwork y no acceden a tu sistema operativo, memoria, disco duro ni archivos externos arbitrarios.",
            "Para recibir mensajes entrantes de WhatsApp/WeChat, mantén activa la pestaña del navegador donde está Paiperwork y evita que el equipo entre en reposo. La pantalla de bloqueo detendrá los mensajes entrantes; considera desactivarla temporalmente para habilitar las funciones de WhatsApp/WeChat.",
            ...
            "Puedes crear presentaciones y mini apps a partir de resúmenes de documentos y sus modificaciones de seguimiento, informes de investigación y sus modificaciones de seguimiento, y entradas de la base de conocimiento y sus modificaciones de seguimiento."
        ],
        articles: [
            {
                id: "connectors-pairing",
                title: "Emparejamiento y Modos",
                content: `
                <p>WhatsApp: Abre la pestaña Conectores y elige un modo antes de iniciar el servidor.</p>
                <ol>
                    <li><strong>Modo personal:</strong> conectas tu propia cuenta de WhatsApp y hablas contigo mismo en un flujo privado.</li>
                    <li><strong>Modo bot:</strong> las personas que te tienen en su lista de contactos de WhatsApp pueden hablar con la instancia emparejada de Paiperwork. Usa un número separado salvo que quieras este comportamiento en tu cuenta principal.<br><strong>2.1.</strong> Puedes mejorar la experiencia de usuario al interactuar con el bot modificando el System Prompt en la pestaña Chat.<br><strong>2.2.</strong> Cualquier usuario de WhatsApp que esté en tu lista de contactos podrá acceder a las funciones del conector habilitadas y a los documentos almacenados disponibles a través del conector.<br><strong>2.3.</strong> No puedes iniciar mensajes desde Paiperwork hacia usuarios de WhatsApp para evitar abusos y spam.<br><strong>2.4.</strong> Si cierras el servidor en modo bot, los mensajes pendientes de los usuarios quedarán en cola hasta el siguiente inicio del servidor y luego se procesarán uno a uno. Si quieres omitir esos mensajes, inicia el servidor en modo personal; todos los mensajes entrantes serán ignorados excepto los que te envíes a ti mismo.</li>
                </ol>
                <p>Haz clic en <strong>Start server</strong> y escanea el código QR la primera vez que emparejes. Puedes detener el servidor en cualquier momento, lo que detiene el enrutado de mensajes en ambas direcciones.</p>
                <p>WeChat: Para emparejar el bot de WeChat, haz clic en el botón Start server, escanea el código QR y sigue las instrucciones en la app WeChat de tu teléfono. Los inicios de servidor posteriores conservarán la misma información de emparejamiento a menos que elimines el dispositivo emparejado.</p>
                <p>Si quieres eliminar por completo el enlace con Paiperwork, hazlo desde tu teléfono en WhatsApp/WeChat dentro de <strong>Linked devices</strong>.</p>
            `,
            },
            {
                id: "connectors-models-chat",
                title: "Selección de Modelo y Chat",
                content: `
                ...
                <ul>
                    ...
                    <li><code>muéstrame mis modelos</code></li>
                    <li><code>cambia el modelo actual a &lt;nombre del modelo&gt;</code></li>
                    <li><code>usa &lt;nombre del modelo&gt;</code></li>
                </ul>
                <p>Si no quieres permitir cambios de modelo desde WhatsApp, pulsa <strong>Bloquear modelo de IA</strong> en la pestaña Conectores.</p>
                ...
                <ul>
                    ...
                    <li><code>explica la diferencia entre OLED y Mini LED</code></li>
                </ul>
            `,
            },
            {
                ...
                <ul>
                    ...
                    <li><code>quiero revisar un documento pero no recuerdo el nombre</code></li>
                    <li><code>quiero hacer una pregunta a un documento</code></li>
                    <li><code>&lt;nombre del documento&gt; y tu pregunta</code></li>
                    <li><code>resumir &lt;nombre del documento&gt;</code></li>
                    <li><code>&lt;nombre del documento&gt; resumir y crear una presentación</code></li>
                    <li><code>&lt;nombre del documento&gt; resumir y crear una mini app</code></li>
                </ul>
                <p>Para salir del modo de seguimiento de documentos, usa <code>salir del modo documento</code> o <code>ya terminé</code>.</p>
                <h5>Interacciones</h5>
                ...
                <p><strong>Usuario:</strong> <code>Sí, crear una presentación</code></p>
                <p><strong>Paiperwork:</strong> Creando una presentación promptable de SlideForge...</p>
                <p><strong>Paiperwork:</strong> Presentación creada y enviada como archivo HTML.</p>
                <p><strong>Paiperwork:</strong> ¿Quieres hacer más cambios en esta presentación?</p>
                ...
                <ul>
                    ...
                    <li><code>crear un gráfico de barras sobre ventas por trimestre</code></li>
                </ul>
                <p>Proporciona tus propios datos si quieres un gráfico real en lugar de una demo.</p>
                ...
                <ul>
                    ...
                    <li><code>crear un informe sobre el clima en Inglaterra</code></li>
                    <li><code>también agrega el impacto del clima en la afluencia a las playas</code></li>
                </ul>
                <p>Para cerrar el modo de seguimiento de investigación, responde <code>no</code>, <code>no gracias</code> o <code>ya terminé</code>.</p>
                <h5>Interacciones</h5>
                <p><strong>Paiperwork:</strong> La investigación ha comenzado para <code>&lt;tema de investigación&gt;</code>. Recopilando información...</p>
                ...
                <p>Puedes navegar por tu base de conocimiento guardada desde WhatsApp listando colecciones, abriendo una colección, listando sus entradas y leyendo la entrada seleccionada. Los nombres de las colecciones y de las entradas no tienen que ser exactos.</p>
                <p>Entra en este modo con <code>modo conocimiento</code>, <code>modo base de conocimiento</code>, <code>modo base de conocimientos</code> o <code>modo kb</code>.</p>
                <ul>
                    <li><code>Mostrar mi base de conocimiento</code></li>
                    <li><code>Listar mis colecciones de conocimiento</code></li>
                    <li><code>Abrir la colección &lt;nombre de la colección&gt;</code></li>
                    <li><code>Mostrar la colección de conocimiento &lt;nombre de la colección&gt;</code></li>
                    <li><code>Leer la entrada &lt;nombre de la entrada&gt;</code></li>
                    <li><code>Abrir el artículo &lt;nombre de la entrada&gt; de la colección &lt;nombre de la colección&gt;</code></li>
                </ul>
                <p>Después de que Paiperwork envíe una entrada de conocimiento, esa entrada queda en memoria para que puedas traducirla, acortarla, reescribirla o cambiar su formato sin volver a abrir la colección.</p>
                <h5>Paiperwork:Interacción usuario</h5>
                <p><strong>Usuario:</strong> <code>Mostrar mi base de conocimiento</code></p>
                <p><strong>Paiperwork:</strong> Aquí tienes tus colecciones de conocimiento.</p>
                <p><strong>Paiperwork:</strong> Elige una colección por número o por nombre.</p>
                <p><strong>Usuario:</strong> <code>Abrir la colección Project Research</code></p>
                <p><strong>Paiperwork:</strong> Aquí están las entradas de <code>Project Research</code>.</p>
                <p><strong>Paiperwork:</strong> Elige una entrada por número o por nombre.</p>
                <p><strong>Usuario:</strong> <code>Leer la entrada Battery supply chain</code></p>
                <p><strong>Paiperwork:</strong> Enviando la entrada de conocimiento de <code>Project Research</code>.</p>
                <p><strong>Paiperwork:</strong> Contenido de la entrada entregado en WhatsApp.</p>
                <p><strong>Paiperwork:</strong> ¿Quieres seguir trabajando con esta entrada de conocimiento?</p>

                <h5>Transformaciones de seguimiento para entradas de conocimiento</h5>
                <p>Después de entregar una entrada de conocimiento, puedes seguir transformando el texto en memoria sin volver a navegar por la base de conocimiento.</p>
                <ul>
                    <li><code>Traduce la entrada al portugués</code></li>
                    <li><code>Hazla más corta</code></li>
                    <li><code>Ponla en viñetas</code></li>
                    <li><code>Reescribe esta nota más claramente</code></li>
                </ul>
                ...
                <div class="note"><p><strong>Nota:</strong> Cuando descargues el archivo HTML de la presentación en tu ordenador, podrás editarlo sin conexión con la pequeña barra de herramientas de la esquina superior derecha. Este flujo de edición no es compatible con teléfonos ni tablets. Usa <strong>Edit text</strong> para modificar cualquier texto directamente, haz clic en cualquier imagen de la presentación para sustituirla por una imagen local, usa <strong>Fullscreen</strong> para verla a pantalla completa y usa <strong>Save</strong> para guardar el resultado actualizado como un nuevo archivo HTML. La barra de herramientas desaparece automáticamente cuando la presentación está en pantalla completa.</p></div>
                <ul>
                    <li><code>crear una presentación con el siguiente texto: &lt;texto de la presentación&gt;</code></li>
                    <li><code>usar el siguiente texto para crear una presentación: &lt;texto de la presentación&gt;</code></li>
                    <li><code>hazme diapositivas sobre la política europea de vehículos eléctricos, usa búsqueda web, 7 diapositivas</code></li>
                    <li><code>listar mis presentaciones</code></li>
                    <li><code>envíame &lt;nombre de la presentación&gt;</code></li>
                </ul>
                <h5>Interacciones</h5>
                <p><strong>Usuario:</strong> <code>Crea una presentación sobre el sistema solar y sus planetas, busca en internet.</code></p>
                <p><strong>Paiperwork:</strong> Creando una presentación promptable de SlideForge usando búsqueda web...</p>
                <p><strong>Paiperwork:</strong> Presentación creada y enviada como archivo HTML.</p>
                <p><strong>Paiperwork:</strong> ¿Quieres hacer más cambios en esta presentación?</p>
                <p><strong>Usuario:</strong> <code>Sí, cambia el fondo de la diapositiva 3 a tema azul</code></p>
                ...
                <ul>
                    <li><code>crear una mini app de fondo animado relajante con distintos ruidos y osciladores de baja frecuencia, con búsqueda web</code></li>
                    <li><code>crear artefacto del juego Galaga</code></li>
                    <li><code>crear una mini app para encontrar canales de tv online</code></li>
                    <li><code>crear un artefacto mp3 player</code></li>
                    <li><code>muéstrame mis mini apps</code></li>
                    <li><code>muéstrame mis artefactos</code></li>
                    <li><code>envíame &lt;nombre del artefacto&gt; mini app</code></li>
                    <li><code>envíame &lt;nombre del artefacto&gt; artefacto</code></li>
                </ul>
                <h5>Interacciones</h5>
                <p><strong>Paiperwork:</strong> ¿Quieres hacer más modificaciones a esta mini app?</p>
                <p><strong>Usuario:</strong> <code>Sí, cambia el fondo</code></p>
                <p><strong>Paiperwork:</strong> ¿Quieres hacer más modificaciones a esta mini app?</p>
                <p><strong>Usuario:</strong> <code>No</code></p>
            ...
            {
                id: "connectors-notes",
                title: "Notas Operativas y Límites",
                content: `
                <ul>
                    ...
                    <li>De forma predeterminada, Paiperwork aísla el estado del conector de WhatsApp/WeChat por usuario de Master Key para que las sesiones guardadas, el estado del dispositivo y los datos de ejecución en cola no se filtren entre distintos usuarios de Master Key en el mismo equipo.</li>
                </ul>
            `,
            }
        ],
