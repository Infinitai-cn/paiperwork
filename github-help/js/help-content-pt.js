    ...
    connectors: {
        ...
        articles: [
            ...
            },
            {
                ...
                <div class="note"><p><strong>Nota:</strong> Depois de descarregar o ficheiro HTML da apresentação para o seu computador, pode editá-lo offline com a pequena barra de ferramentas no canto superior direito. Telemóveis e tablets não são suportados neste fluxo de edição. Clique em <strong>Edit text</strong> para modificar qualquer texto diretamente, clique em <strong>Replace image</strong> para substituir a imagem do slide atual por uma imagem local e depois guarde o resultado como um novo ficheiro HTML. A barra de ferramentas desaparece automaticamente quando a apresentação entra em ecrã inteiro.</p></div>
                <ul>
