    ...
    presentation: {
        ...
        `,
            ...
            <ul>
                ...
                <li><strong>Image replace tip</strong> — if an image fails to load, or you simply want a different one, click the image in the preview and start an image search to replace it.</li>
                <li><strong>Text edit tip</strong> — text boxes are directly editable in the preview, so you can make final wording tweaks before saving the HTML presentation.</li>
    ...
    connectors: {
        ...
        articles: [
            ...
            },
            {
                ...
                <div class="note"><p><strong>Note:</strong> After you download the presentation HTML file to your computer, you can use the small toolbar in the top-right corner to edit it offline. Phones and tablets are not supported for this editing flow. Use <strong>Edit text</strong> to modify text directly, click any image in the presentation to replace it with a local image, use <strong>Fullscreen</strong> to view the presentation in fullscreen, and use <strong>Save</strong> to store the updated result as a new HTML file. The toolbar disappears automatically while the presentation is in fullscreen mode.</p></div>
                <ul>
