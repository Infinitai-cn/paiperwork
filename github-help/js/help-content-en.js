    ...
    connectors: {
        ...
        articles: [
            ...
            },
            {
                ...
                <div class="note"><p><strong>Note:</strong> After you download the presentation HTML file to your computer, you can use the small toolbar in the top-right corner to edit it offline. Phones and tablets are not supported for this editing flow. Click <strong>Edit text</strong> and modify any text directly, click <strong>Replace image</strong> to replace the current slide picture with a local image, then save the result as a new HTML file. The toolbar disappears automatically while the presentation is in fullscreen mode.</p></div>
                <ul>
