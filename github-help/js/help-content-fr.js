    ...
    connectors: {
        ...
        articles: [
            ...
            },
            {
                ...
                <div class="note"><p><strong>Remarque :</strong> Une fois le fichier HTML de présentation téléchargé sur votre ordinateur, vous pouvez le modifier hors ligne avec la petite barre d'outils en haut à droite. Les téléphones et tablettes ne sont pas pris en charge pour ce flux d'édition. Cliquez sur <strong>Edit text</strong> pour modifier n'importe quel texte directement, cliquez sur <strong>Replace image</strong> pour remplacer l'image de la diapositive actuelle par une image locale, puis enregistrez le résultat comme nouveau fichier HTML. La barre d'outils disparaît automatiquement lorsque la présentation est en plein écran.</p></div>
                <ul>
