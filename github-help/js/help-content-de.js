    ...
    connectors: {
        ...
        articles: [
            ...
            },
            {
                ...
                <div class="note"><p><strong>Hinweis:</strong> Sobald Sie die Präsentations-HTML-Datei auf Ihren Computer heruntergeladen haben, können Sie sie mit der kleinen Werkzeugleiste oben rechts offline bearbeiten. Telefone und Tablets werden für diesen Bearbeitungsablauf nicht unterstützt. Klicken Sie auf <strong>Edit text</strong> und ändern Sie beliebigen Text direkt, klicken Sie auf <strong>Replace image</strong>, um das Bild der aktuellen Folie durch ein lokales Bild zu ersetzen, und speichern Sie das Ergebnis anschließend als neue HTML-Datei. Im Vollbildmodus verschwindet die Werkzeugleiste automatisch.</p></div>
                <ul>
