class ArtworksTab {
    ...
    `;
        ...
        if (!document.querySelector('style[data-artwork-progress]')) {
            // Add styles for the floating window
            const styles = document.createElement('style');
            styles.setAttribute('data-artwork-progress', 'true');
            styles.textContent = `
            .artwork-progress-window {
                position: fixed;
                top: 50%;
                left: 50%;
            ...
            .artwork-progress-header h3 {
                margin: 0;
                font-size: 16px;
                color: #1e293b;
            }
            
            .artwork-progress-close {
                background: none;
                border: none;
                color: #64748b;
                cursor: pointer;
            ...
            .artwork-progress-close:hover {
                background-color: rgba(100, 116, 139, 0.1);
            }
            
            .artwork-progress-content {
                padding: 30px 20px;
                display: flex;
