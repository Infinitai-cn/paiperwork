...
- View the gallery: <a href="https://Infinitai-cn.github.io/paiperwork/github-help/video-demos.html" target="_blank" rel="noopener noreferrer">Open video demo gallery</a>
...
**Runs on Consumer Hardware** - We tested it with Core i3 laptops with 16GB of RAM on CPU mode (Qwen3 1.7b) and it performed well, so Paiperwork is good for not-so-powerful consumer hardware, also, you have the option to run Ollama cloud models for a more powerful experience.
