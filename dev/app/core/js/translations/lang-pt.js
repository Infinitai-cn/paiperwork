if (typeof window.portugueseTranslationsLoaded === 'undefined') {
  ...
  // Presentation Generator
    ...
    // PDF Works Tab
    pdfWorksTitle: "Transformador de Texto PDF",
    pdfWorksControlsTitle: "Controles de Transformação",
    pdfWorksDragDrop: "Arraste e solte um PDF aqui",
    pdfWorksSupportedFormat: "Formato suportado: .pdf (com texto)",
    ...
    pdfWorksScopeHintDocument: "Escopo documento: todas as páginas serão alvo da transformação.",
    pdfWorksInstructionLabel: "Instrução",
    pdfWorksInstructionPlaceholder: "Descreva o que deve ser alterado no texto selecionado...",
    pdfWorksReopenPreviewButton: "Abrir janela de pré-visualização",
    pdfWorksTransformButton: "Transformar",
    pdfWorksTransformingButton: "Transformando...",
    pdfWorksDoneButton: "Concluído",
    pdfWorksRetryButton: "Tentar novamente",
    pdfWorksOnlyPdfSupported: "Apenas arquivos PDF são suportados nesta aba.",
    pdfWorksPreviewTitle: "Pré-visualização PDF — {fileName}",
    ...
    pdfWorksExportButton: "Exportar PDF reconstruído",
    pdfWorksExportingButton: "Exportando...",
    pdfWorksExportDoneButton: "Exportado",
    pdfWorksExportingStatus: "Gerando exportação do PDF reconstruído...",
    pdfWorksExportDone: "PDF reconstruído exportado com sucesso.",
    pdfWorksExportFailed: "Falha na exportação: {error}",
    pdfWorksNoExtractableTitle: "O PDF não possui texto extraível",
    pdfWorksNoExtractableMessage: "O arquivo \"{fileName}\" parece não conter texto extraível (por exemplo, apenas imagens escaneadas). A pré-visualização editável do PDF Works não foi aberta para este arquivo.",
