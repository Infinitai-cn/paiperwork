window.helpContent = {
    ...
    gettingstarted: {
        ...
        intro: [
            ...
            "Aviso do modo online (<a href=\"https://huggingface.co/spaces/Infinitai/Paiperwork\" target=\"_blank\" rel=\"noopener noreferrer\">Hugginface spaces</a>): Devido a requisitos locais, as abas Documents, Translate e Models ficam desativadas no modo online. Essas abas sao ativadas quando voce executa o Paiperwork no seu computador."
        ],
        articles: [
            {
                id: "gs-welcome",
