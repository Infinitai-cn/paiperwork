window.helpContent = {
    ...
    gettingstarted: {
        ...
        intro: [
            ...
            "在线模式（<a href=\"https://huggingface.co/spaces/Infinitai/Paiperwork\" target=\"_blank\" rel=\"noopener noreferrer\">Hugginface spaces</a>）提示：由于本地环境要求，Documents、Translate 和 Models 这三个选项卡在在线模式下会被禁用。仅当您在电脑上本地运行 Paiperwork 时，这些选项卡才会启用。"
        ],
        articles: [
            {
                id: "gs-welcome",
        ...
        <div class="note">
            ...
            <ul>
                ...
                <li>它充当您安全存储对话数据的加密密钥（您的数据将以数据库形式本地存储在浏览器存储中）。除了激活网页按钮进行网页搜索时的搜索提示或研究功能（向微软必应搜索引擎发送网页搜索查询）或 Ollama 模型查询/下载外，不会有任何数据发送到您的系统之外。不收集遥测数据。请注意，如果您更换浏览器，将不会有之前的数据库，因此您将重新开始。</li>
            </ul>
    ...
    `,
            ...
            },
            {
                ...
                title: "保护密码功能",
                content: `
                <p>Paiperwork 包含一个可选的保护密码功能，为您存储的数据库提供额外的安全层，防止意外数据删除。</p>
                ...
                <p>当您首次尝试删除所有信息时：</p>
                <ol>
                    <li>点击欢迎界面上的"删除所有信息"按钮</li>
                    <li>如果不存在保护密码，系统会提示您设置一个</li>
                    <li>选择是否设置保护密码或跳过此功能（只需关闭此窗口）</li>
                    <li>如果您选择设置：输入密码（最少6个字符）并确认</li>
                    <li>密码将被安全加密并本地存储</li>
                </ol>
                ...
                <p>一旦设置了保护密码：</p>
                <ul>
                    <li>任何删除所有信息的尝试都需要密码验证</li>
                    <li>在验证对话框中输入您的保护密码</li>
                    <li>只有输入正确密码才能继续删除</li>
                    <li>密码验证包含"重置密码"选项，如果您需要更改它</li>
                </ul>
                
                <h4>重置您的保护密码</h4>
                <p>如果您需要更改保护密码：</p>
                <ol>
                    <li>尝试删除所有信息以打开密码验证对话框</li>
                    <li>在输入字段中输入您当前的密码</li>
                    <li>点击"重置密码"按钮</li>
                    <li>如果您当前的密码正确，系统将指导您设置新密码</li>
                </ol>
                
                <h4>安全详情</h4>
                <ul>
                    <li><strong>加密</strong> - 密码使用 SHA-256 和唯一盐进行哈希</li>
                    <li><strong>本地存储</strong> - 保护密码仅存储在您的设备上</li>
                    <li><strong>无恢复</strong> - 如果您忘记保护密码，无法恢复</li>
                    <li><strong>可选功能</strong> - 如果您愿意，可以跳过设置保护密码（仅在从数据库删除所有信息时需要）</li>
                </ul>
                
                <div class="note">
                    <p><strong>重要：</strong>保护密码旨在防止意外删除。如果您忘记保护密码，没有恢复方法（您需要删除浏览器对 localhost 的本地存储以重新开始，这将丢失 Paiperwork 的所有存储信息）。选择一个您会记住但不容易被猜到的密码。</p>
                </div>
            `,
                image: "protection_password.png",
                imageAlt: "保护密码设置",
                imageCaption: "用于保护数据删除的保护密码设置对话框",
            },
        ],
    },
    chat: {
    ...
    models: {
        ...
        articles: [
            ...
            },
            {
                ...
                <div class="note">
                    <p><strong>重要：</strong>修改modelparameters.js文件后，您需要重启应用程序以使更改生效。</p>
                </div>
                `,
        ...
        articles: [
            ...
            },
            {
                ...
                <ol>
                    ...
                    <li>返回欢迎界面</li>
                    <li>点击"删除所有信息"重置数据库</li>
                    <li>这将删除所有数据并创建新的数据库</li>
                </ol>
