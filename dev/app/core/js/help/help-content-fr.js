window.helpContent = {
    ...
    gettingstarted: {
        ...
        intro: [
            ...
            "Avis mode en ligne (<a href=\"https://huggingface.co/spaces/Infinitai/Paiperwork\" target=\"_blank\" rel=\"noopener noreferrer\">Hugginface spaces</a>) : En raison des exigences locales, les onglets Documents, Translate et Models sont desactives en mode en ligne. Ces onglets sont actives lorsque vous executez Paiperwork sur votre ordinateur."
        ],
        articles: [
            {
                id: "gs-welcome",
